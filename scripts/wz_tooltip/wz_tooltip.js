...
config. BgColor			= '#FFFFB9' // '#E2E7FF'	// Background colour (HTML colour value, in quotes)
...
config. FontFace		= 'ubuntu_font' //'Verdana,Geneva,sans-serif'
...
config. OffsetY			= 14		// Vertical offset
